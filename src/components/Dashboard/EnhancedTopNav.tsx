          ...
          <div className="relative max-w-md flex-1 sm:flex-initial">
            <form onSubmit={handleSearchSubmit} className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 w-full sm:w-64 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
              />
              {searchTerm && (
                <Button
                  type="button"
            ...
            {showSearchResults && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
                {isSearching ? (
